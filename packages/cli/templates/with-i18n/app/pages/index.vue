  ...
  <div class="flex flex-col items-center justify-center gap-8">
    <header class="flex w-full flex-col items-center gap-4 p-4">
      <div class="flex flex-col items-center gap-2 text-center">
        ...
        <p>
          If you're seeing this, it means you've successfully set up your Nuxt.js project via <code class="text-primary">@matimortari/nuxtjs-starter</code>.
        </p>
      </div>
    </header>
...
const features = [
  ...
  { icon: "ph:translate", label: "Nuxt i18n" },

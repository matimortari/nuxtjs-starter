...
Used to showcase the structure and capabilities of the project.

#### Shared Packages (`packages/`)

**nuxtjs-starter CLI (`packages/cli`)**:
- An npm package to quickly scaffold Nuxt.js starter projects.
